...
template <typename T>
NickJumpCtrl<T>::~NickJumpCtrl() {}

template <typename T>
void NickJumpCtrl<T>::OneStep(float _curr_time, bool b_preparation, LegControllerCommand<T>* command) {
...
template class NickJumpCtrl<double>;
template class NickJumpCtrl<float>;
