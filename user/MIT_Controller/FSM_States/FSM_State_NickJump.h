#ifndef FSM_STATE_NICKJUMP_H
#define FSM_STATE_NICKJUMP_H

#include "FSM_State.h"
#include <Controllers/BackFlip/DataReader.hpp>
#include <Controllers/BackFlip/NickJumpCtrl.hpp>
 ...
 */
template <typename T>
class FSM_State_NickJump : public FSM_State<T> {
 public:
  FSM_State_NickJump(ControlFSMData<T>* _controlFSMData);
